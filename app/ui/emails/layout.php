                    ...
                    <td class="o_bg-white o_px o_py-md o_br-t o_sans o_text" align="center" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 16px;line-height: 24px;background-color: #ffffff;border-radius: 4px 4px 0px 0px;padding-left: 16px;padding-right: 16px;padding-top: 24px;padding-bottom: 24px;">
                        <p style="margin-top: 0px;margin-bottom: 0px;">
                            <a class="o_text-primary" href="<?php echo $domainUrl; ?>" style="text-decoration: none;outline: none;color: #126de5;">
                                <img src="<?php echo $domainUrl; ?>assets/img/aumet-logo.png" width="136" height="36" alt="Aumet Inc" style="max-width: 136px;-ms-interpolation-mode: bicubic;vertical-align: middle;border: 0;line-height: 100%;height: auto;outline: none;text-decoration: none;"></a></p>
                    </td>
                </tr>
                </tbody>
            </table>
            ...
            <table class="o_block-lg" width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation" style="max-width: 800px;margin: 0 auto;">
                    ...
                    <td class="o_re o_px o_pb-lg" align="center" style="font-size: 0;vertical-align: top;padding-left: 16px;padding-right: 16px;padding-bottom: 32px;">
                        ...
                        <div class="o_col o_col-2 o_col-full" style="display: inline-block;vertical-align: top;width: 100%;max-width: 200px;">
                            ...
                            <div class="o_px-xs o_sans o_text-xs o_center" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 14px;line-height: 21px;text-align: center;padding-left: 8px;padding-right: 8px;">
                                <p style="margin-top: 0px;margin-bottom: 0px;">
                                    <a class="o_text-light" href="" style="text-decoration: none;outline: none;color: #82899a;">
                                        <strong style="color: #82899a;">
                        ...
                        <div class="o_col o_col-2 o_col-full" style="display: inline-block;vertical-align: top;width: 100%;max-width: 200px;">
                            ...
                            <div class="o_px-xs o_sans o_text-xs o_center" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 14px;line-height: 21px;text-align: center;padding-left: 8px;padding-right: 8px;">
                                <p style="margin-top: 0px;margin-bottom: 0px;">
                                    <a class="o_text-light" href="https://www.facebook.com/aumet.me/" style="text-decoration: none;outline: none;color: #82899a;"><img src="<?php echo $domainUrl; ?>assets/img/facebook.png" width="24" height="24" alt="fb" style="max-width: 24px;-ms-interpolation-mode: bicubic;vertical-align: middle;border: 0;line-height: 100%;height: auto;outline: none;text-decoration: none;"></a><span> &nbsp;</span>
                                    <a class="o_text-light" href="https://twitter.com/aumet_me" style="text-decoration: none;outline: none;color: #82899a;"><img src="<?php echo $domainUrl; ?>assets/img/twitter.png" width="24" height="24" alt="tw" style="max-width: 24px;-ms-interpolation-mode: bicubic;vertical-align: middle;border: 0;line-height: 100%;height: auto;outline: none;text-decoration: none;"></a><span> &nbsp;</span>
                                    <a class="o_text-light" href="https://www.linkedin.com/company/aumet-co-/" style="text-decoration: none;outline: none;color: #82899a;"><img src="<?php echo $domainUrl; ?>assets/img/linkedin.png" width="24" height="24" alt="ig" style="max-width: 24px;-ms-interpolation-mode: bicubic;vertical-align: middle;border: 0;line-height: 100%;height: auto;outline: none;text-decoration: none;"></a><span> &nbsp;</span>
                                    <a class="o_text-light" href="https://www.youtube.com/channel/UCRrmnEByhmju6Cjl_N-cV1A" style="text-decoration: none;outline: none;color: #82899a;"><img src="<?php echo $domainUrl; ?>assets/img/youtube.png" width="24" height="24" alt="sc" style="max-width: 24px;-ms-interpolation-mode: bicubic;vertical-align: middle;border: 0;line-height: 100%;height: auto;outline: none;text-decoration: none;"></a>
                                </p>
                            </div>
                        </div>
                        <!--[if mso]></td><td width="200" align="center" valign="top" style="padding:0px 8px;"><![endif]-->
                        <div class="o_col o_col-2 o_col-full" style="display: inline-block;vertical-align: top;width: 100%;max-width: 200px;">
                            <div style="font-size: 32px; line-height: 32px; height: 32px;">&nbsp; </div>
                            <div class="o_px-xs o_sans o_text-xs o_center" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 14px;line-height: 21px;text-align: center;padding-left: 8px;padding-right: 8px;">
                                <p style="margin-top: 0px;margin-bottom: 0px;"><a class="o_text-light" href="" style="text-decoration: none;outline: none;color: #82899a;"><strong style="color: #82899a;"></strong></a></p>
                            </div>
                        </div>
                        <!--[if mso]></td></tr></table><![endif]-->
                    </td>
                ...
                <tr>
                    <td class="o_px-md o_pb-lg o_sans o_text-xs o_text-light" align="center" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 14px;line-height: 21px;color: #82899a;padding-left: 24px;padding-right: 24px;padding-bottom: 32px;">
                        <p class="o_mb-xs" style="margin-top: 0px;margin-bottom: 8px;">©<?php echo date('Y') ?> Aumet Inc<br>
                            133 Kearny street, Suite 401, San Francisco, USA
                        </p>
                        <p style="margin-top: 0px;margin-bottom: 0px;">
                            <a class="o_text-xxs o_text-light o_underline" href="<?php echo "$domainUrl/en/settings/email/unsubscribe/"?>" style="text-decoration: underline;outline: none;font-size: 12px;line-height: 19px;color: #82899a;">Unsubscribe</a>
                        </p>
                    </td>
                </tr>
                </tbody>
